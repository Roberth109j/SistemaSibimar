...
import { type AutorShowProps } from './types';

export default function ShowAutor({ isModal, open, onClose, autor }: AutorShowProps) {
  if (!open) return null;
      ...
      <div className="relative w-full max-w-md mx-auto overflow-hidden rounded-lg shadow-2xl transform transition-all duration-300 animate-fade-in-up">
        <div className="bg-blue-600 px-6 py-4 text-white">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold">Detalles del Autor</h2>
