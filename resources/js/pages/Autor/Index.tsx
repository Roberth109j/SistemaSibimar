...
import { type BreadcrumbItem, type Autor, type AutorIndexProps } from './types';
...
export default function Index({ autores, flash, errors }: AutorIndexProps) {
  const page = usePage();
  ...
  const openShowModal = (autor: Autor) => {
    setSelectedAutor(autor);
