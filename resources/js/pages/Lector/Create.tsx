...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  {
    title: 'Crear Lector',
    href: '/lectores/create',
  },
];

interface CreateLectorProps {
  auth: any;
  grados: Array<{
    id: number;
    grado: string;
...
export default function Create({ auth, grados }: CreateLectorProps) {
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Complete los datos para registrar un nuevo lector en el sistema
                  </p>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <label className={`relative flex items-center p-3 rounded-lg border-2 cursor-pointer transition-all duration-200 ${
                      data.estado === 'ACTIVO' 
                        ...
                        : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 hover:border-green-300 dark:hover:border-green-600'
                    }`}>
                      <input
                        type="radio"
                        name="estado"
                    ...
                    <label className={`relative flex items-center p-3 rounded-lg border-2 cursor-pointer transition-all duration-200 ${
                      data.estado === 'INACTIVO' 
                        ...
                        : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 hover:border-red-300 dark:hover:border-red-600'
                    }`}>
                      <input
                        type="radio"
                        name="estado"
                ...
                <div className="flex flex-col sm:flex-row sm:justify-end sm:space-x-4 space-y-3 sm:space-y-0 pt-6 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <button
                    type="submit"
                    disabled={processing}
                    className={`inline-flex items-center justify-center px-6 py-3 border-2 border-transparent text-sm font-medium rounded-lg text-white transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-4 ${
                      processing
                        ? 'bg-gray-400 dark:bg-gray-600 cursor-not-allowed'
                        : 'bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 focus:ring-indigo-200 dark:focus:ring-indigo-800 shadow-lg hover:shadow-xl'
                    }`}
                  >
                    {processing ? (
                      <>
