...
export default function Create({ auth, grados, flash }: CreateLectorProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post(route('lectores.store'), {
      onSuccess: (page: any) => {
        const successMessage = page.props.flash?.success || 'Lector creado exitosamente';
        setShowAlert({
          show: true,
          type: 'success',
      ...
      onError: (errors: any) => {
        ...
        if (!hasFieldErrors) {
          const errorMessage = errors.error || 'Ha ocurrido un error al crear el lector';
          setShowAlert({
            show: true,
            type: 'error',
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Registra un nuevo usuario en el sistema bibliotecario
              </p>
            </div>
          </div>
