...
export default function DevelopersModal({ isOpen, onClose }: DevelopersModalProps) {
  const developers: Developer[] = [
    {
      name: "Giovanni Albeiro Hernández",
      role: "Developer",
      linkedin: "https://www.linkedin.com/in/giovanni-hernandez-949b6456?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
      github: "",
      avatar: "https://ui-avatars.com/api/?name=Giovanni+Hernandez&background=f97316&color=fff&bold=true&size=80",
