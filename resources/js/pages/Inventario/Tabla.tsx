        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {libros.data.map((libro, index) => {
              ...
              // Calcular total en circulación - convertir a números para evitar concatenación
              const totalEnCirculacion = Number(libro.ejemplares_disponibles_count || 0) + Number(libro.ejemplares_prestados_count || 0);
              ...
              return (
                <tr key={libro.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="px-6 py-4 text-center">
                    <BadgeEstado tipo="disponibles" cantidad={Number(libro.ejemplares_disponibles_count || 0)} />
                  </td>
                  <td className="px-6 py-4 text-center">
                    <BadgeEstado tipo="prestados" cantidad={Number(libro.ejemplares_prestados_count || 0)} />
                  </td>
                  <td className="px-6 py-4 text-center">
                    <BadgeEstado tipo="dados_baja" cantidad={Number(libro.ejemplares_dados_baja_count || 0)} />
                  </td>
                  <td className="px-6 py-4 text-center">
                    <BadgeEstado tipo="perdidos" cantidad={Number(libro.ejemplares_perdidos_count || 0)} />
                  </td>
                  <td className="px-6 py-4 text-center">
